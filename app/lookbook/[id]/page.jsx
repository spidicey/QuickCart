...
export default function LookbookDetail() {
  ...
  const { fetchLookbookById, currency, addToCart, router } = useAppContext();
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
          <div className="p-8 md:p-12 text-white">
            ...
            <p className="text-sm opacity-90">
              {Object.keys(groupedProducts).length} sản phẩm • {lookbook.items?.length} phiên bản
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 text-sm text-gray-600 mb-8">
        ...
        <span>/</span>
        <Link href="/lookbooks" className="hover:text-orange-600">Lookbooks</Link>
        <span>/</span>
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => handleAddToCart(product.productId, variants[0].variantId)}
        ...
        <div className="space-y-4">
          {Object.values(groupedProducts).map(({ product, variants }) => (
            <div key={product.productId} className="bg-white rounded-lg p-4">
              <h3 className="font-semibold text-lg mb-3">{product.product_name}</h3>
