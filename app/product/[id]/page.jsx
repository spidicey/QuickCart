          ...
          <div className="flex flex-col">
            ...
            <p className="text-3xl font-medium mt-6">
              ...
              {selectedVariant?.price.toLocaleString() ||
                productData.variants[0]?.price.toLocaleString()}
            </p>
              ...
              <table className="table-auto border-collapse w-full max-w-72">
                <tbody>
                  ...
                  {productData.category && (
                    <tr>
                      <td className="text-gray-600 font-medium py-1">
                        Category
                      </td>
                  ...
                  {selectedVariant && (
                    <tr>
                      ...
                      <td className="text-gray-800/50 text-xs">
                        {selectedVariant.sku}
                      </td>
                    </tr>
                  )}
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="font-medium">
                          {review.customers?.users?.full_name || "Anonymous"}
                        </span>
                      </div>
                      ...
                      <div className="text-sm text-gray-500 mb-3">
                        ...
                        {
                          review.order_detail?.product_variants?.attribute
                            ?.color
                        }{" "}
                        -{" "}
                        {review.order_detail?.product_variants?.attribute?.size}
                      </div>
                      {review.comment && (
